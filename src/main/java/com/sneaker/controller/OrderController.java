...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse<Order>> createOrder(
        ...
        return ResponseEntity.status(201).body(ApiResponse.success("Tạo đơn hàng thành công", created));
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getOrders(
        ...
        Page<Order> orders = orderService.getOrders(customer, orderStatus, paymentStatus, startDate, endDate, search, pageable);
